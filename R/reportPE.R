...
reportPE <- function(gdx, regionSubsetList = NULL, t = c(seq(2005, 2060, 5), seq(2070, 2110, 10), 2130, 2150)) {
  ...
  out <- mbind(
    ...
    get_demPE("pemanure",                                            name = "PE|Biomass|+++|Manure (EJ/yr)"),
    get_demPE("pemanure","seel",                                     name = "PE|Biomass|Manure|+|Electricity (EJ/yr)"),
    get_demPE("pemanure","sehe",                                     name = "PE|Biomass|Manure|+|Heat (EJ/yr)"),
    get_demPE("pemanure","segabio",                                  name = "PE|Biomass|Manure|+|Gases (EJ/yr)"),
