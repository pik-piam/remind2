...
reportCharts <- function(gdx = NULL, regionMapping = NULL, hist = NULL, reportfile = NULL, chartType = "ggplot") {
  ...
  out$legend$"Kyoto Gases Emissions"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  out$legend$"CO2 Emissions per Sector"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  # var.tot <-"PE (EJ/yr)"
  vars <- c(
    "Coal with CCS" = "PE|Coal|w/ CC (EJ/yr)",
  ...
  g <- lapply(regionsList, function(reg) {
    ...
    df <- df %>%
      group_by(.data$region, .data$period) %>%
      mutate(percent = .data$value / sum(.data$value) * 100) # creating percentage column
    ...
    df <- df %>%
      group_by(.data$region, .data$period) %>%
      mutate(percapita = .data$value / .data$population) # creating per capita column
  ...
  if ("plotly" %in% chartType) {
    out$plotly$PE$"Total Primary Energy" <- lapply(names(regionsList), function(reg) {
      ggplotly <- lapply(names(g[[reg]]), function(type) {
        gg <- ggplotly(g[[reg]][[type]], tooltip = c("text")) %>%
          hide_legend() %>%
          config(modeBarButtonsToRemove = plotlyButtonsToHide, displaylogo = FALSE)
        return(gg)
      })
  ...
  out$legend$"Total Primary Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  out$legend$"Primary Energy Prices"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = "solid"))
  })
  ...
  out$legend$"Coal production"$contents <- lapply(gsub(" \\(.*", "", vars), function(var) {
    return(list("fill" = color[var], "linetype" = NULL))
  })
  ...
  out$legend$"Gas production"$contents <- lapply(gsub(" \\(.*", "", vars), function(var) {
    return(list("fill" = color[var], "linetype" = NULL))
  })
  ...
  out$legend$"Oil production"$contents <- lapply(gsub(" \\(.*", "", vars), function(var) {
    return(list("fill" = color[var], "linetype" = NULL))
  })
  ...
  out$legend$"Uranium production"$contents <- lapply(gsub(" \\(.*", "", vars), function(var) {
    return(list("fill" = color[var], "linetype" = NULL))
  })
  ...
  out$legend$"Biomass production"$contents <- lapply(gsub(" \\(.*", "", vars), function(var) {
    return(list("fill" = color[var], "linetype" = NULL))
  })
  ...
  out$legend$"Secondary Energy Prices"$contents <- lapply(gsub(" \\(.*", "", vars), function(var) {
  ...
  out$legend$"Total Secondary Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  vars <- c(
    "Coal with CC" = "SE|Electricity|Coal|w/ CC (EJ/yr)",
  ...
  g <- lapply(regionsList, function(reg) {
    ...
    g <- suppressWarnings(
      ggplot(data = df, aes_(x = ~period, y = ~value, fill = ~variable, text = ~details, group = ~variable)) +
        geom_area(alpha = aestethics$alpha) +
        geom_vline(xintercept = as.numeric(min(df$period)), linetype = 2, size = aestethics$`y-axis`$size, color = aestethics$`y-axis`$color) + # vertical line at initial year
        geom_line(
          data = df %>%
  ...
  out$legend$"Electricity Secondary Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  out$legend$"Gases Secondary Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  out$legend$"Heat Secondary Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  out$legend$"Liquids Secondary Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  vars <- c(
    "Biomass" = "SE|Solids|Biomass (EJ/yr)",
  ...
  out$legend$"Solids Secondary Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  vars <- c(
    "Biomass with CC" = "SE|Hydrogen|Biomass|w/ CC (EJ/yr)",
  ...
  out$legend$"Hydrogen Secondary Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  # var.tot <-"FE (EJ/yr)"
  vars <- c(
    "Electricity" = "FE|Electricity (EJ/yr)",
  ...
  out$legend$"Total Final Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  vars <- c(
    "Electricity" = "FE|Transport|Electricity (EJ/yr)",
  ...
  out$legend$"Transport Final Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  out$legend$"Transport Final Energy Prices"$contents <- lapply(gsub(" \\(.*", "", vars), function(var) {
    return(list("fill" = color[var], "linetype" = "solid"))
  })
  ...
  vars <- c(
    "Electricity" = "FE|Industry|Electricity (EJ/yr)",
  ...
  out$legend$"Industry Final Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  out$legend$"Industry Final Energy Prices"$contents <- lapply(gsub(" \\(.*", "", vars), function(var) {
    return(list("fill" = color[var], "linetype" = "solid"))
  })
  ...
  vars <- c(
    "Electricity" = "FE|Buildings|Electricity (EJ/yr)",
  ...
  out$legend$"Buildings Final Energy"$contents <- lapply(names(gsub(" \\(.*", "", vars)), function(var) {
    return(list("fill" = color[gsub(" \\(.*", "", vars[var])], "linetype" = NULL))
  })
  ...
  out$legend$"Buildings Final Energy Prices"$contents <- lapply(gsub(" \\(.*", "", vars), function(var) {
    return(list("fill" = color[var], "linetype" = "solid"))
  })
