...
if ("Production|Industry|Chemicals|Otherchem" %in% levels(data$variable)){ # if process-based chemicals is used
  ...
  items <- c(
    ...
    "Production|Industry|Chemicals|Fertilizer",
...
if ("Production|Industry|Chemicals|CHEM-OLD" %in% levels(data$variable)){ # if process-based chemicals is used
  tot <- "Production|Industry|Chemicals"
  items <- c(
    "Production|Industry|Chemicals|CHEM-OLD",
    "Production|Industry|Chemicals|CHEM-ELC",
    ...
    "Production|Industry|Chemicals|MtOMtA-H2",
