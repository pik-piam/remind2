...
reportEnergyInvestment <- function(gdx, regionSubsetList = NULL,
  ...
  tmp <- mbind(tmp, setNames(v_directteinv[, , "ccsinjeon"]  + v_adjustteinv[, , "ccsinjeon"],         "Energy Investments|CO2 Trans&Stor|Onshore (billion US$2017/yr)") * 1000)
  tmp <- mbind(tmp, setNames(v_directteinv[, , "ccsinjeoff"] + v_adjustteinv[, , "ccsinjeoff"],        "Energy Investments|CO2 Trans&Stor|Offshore (billion US$2017/yr)") * 1000)
  tmp <- mbind(tmp, setNames(tmp[,,"Energy Investments|CO2 Trans&Stor|Onshore (billion US$2017/yr)"]
                           + tmp[,,"Energy Investments|CO2 Trans&Stor|Offshore (billion US$2017/yr)"], "Energy Investments|CO2 Trans&Stor (billion US$2017/yr)"))
